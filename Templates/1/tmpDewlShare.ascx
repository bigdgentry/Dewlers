...
<xmod:Template runat="server" UsePaging="True" Ajax="False" AddRoles="" EditRoles="" DeleteRoles="" DetailRoles="">
  ...
  <script type="text/javascript">
    ...
    $("head").append("<meta property=og:url content=http://www.dewlers.com/Share-A-Dewl?did=<%#Eval("Values")("DewlID")%> />");
    $("head").append("<meta property=og:type content=website />");
    $("head").append('<meta property=og:title content="<%#Eval("Values")("Name")%>" />');
